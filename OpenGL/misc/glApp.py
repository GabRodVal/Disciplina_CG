...
class Shader:
    ...
    def setVec3(self,name,value):
        GL.glUniform3fv(GL.glGetUniformLocation(self.progId,name),1,GL.GL_FALSE,glm.value_ptr(value))
...
class GridMesh:
    ...
    def computePosition(self, attrIndex=0):
        ...
        for i in range(N):
            ...
            for j in range(M):
                ...
                normal.append(n.y)
                normal.append(n.z)
        self.attrBufferData(0, position)
        #self.attrBufferData(1, texCoord, 2)
        self.attrBufferData(1, normal)
    ...
    def attrBufferData(self, attrIndex, data, size=3, type=GL.GL_FLOAT):
        ...
        GL.glVertexAttribPointer(attrIndex,size,type,GL.GL_FALSE,0,ctypes.c_void_p(0))

    def f(self, u, v):
        return glm.vec3(u*5, v*5, 0)
